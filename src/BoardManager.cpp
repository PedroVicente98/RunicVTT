...
void BoardManager::renderToolbar(const ImVec2& window_position)
{
    ...
    static Tool s_spaceReturnTool = Tool::MOVE; // Tool to restore on Space release
    ...
    if (allowHotkeys)
    {
        ...
        if (s_spaceHoldActive && ImGui::IsKeyReleased(ImGuiKey_Space))
        {
            s_spaceHoldActive = false;
            currentTool = s_spaceReturnTool; // restore exactly what was active at press time
        }
